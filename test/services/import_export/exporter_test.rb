...
class ExporterTest < ActiveSupport::TestCase
  class Geojson < ExporterTest
    ...
    test "line layer" do
      geojson = <<~GEOJSON.squish
        {"type":"FeatureCollection","features":[{"type":"Feature","geometry":{"type":"LineString","coordinates":[[2.749597345,48.803795844],[2.834344424,48.752477597],[2.7702115,48.728309678],[2.829763501,48.693547935]]},"properties":{"Name":"Jean-Michel","Document":"touladi.png","calculated_length":19720.582}}]}
      GEOJSON
    ...
    test "polygon layer" do
      geojson = <<~GEOJSON.squish
        {"type":"FeatureCollection","features":[{"type":"Feature","geometry":{"type":"Polygon","coordinates":[[[2.747403413,48.84348962],[2.887763814,48.796096072],[2.751002398,48.736791112],[2.639433875,48.800837444],[2.747403413,48.84348962]]]},"properties":{"calculated_area":108167884.856}}]}
      GEOJSON
    ...
    test "territory layer" do
      geojson = <<~GEOJSON.squish
        {"type":"FeatureCollection","features":[{"type":"Feature","geometry":null,"properties":{"territory":"11","calculated_area":12003436297.606}}]}
      GEOJSON
  ...
  class Csv < ExporterTest
    ...
    test "line layer" do
      csv = <<~CSV
        geojson,Name,Document,calculated_length
        "{""type"":""LineString"",""coordinates"":[[2.749597345,48.803795844],[2.834344424,48.752477597],[2.7702115,48.728309678],[2.829763501,48.693547935]]}",Jean-Michel,touladi.png,19720.582
      CSV
    ...
    test "polygon layer" do
      csv = <<~CSV
        ...
        "{""type"":""Polygon"",""coordinates"":[[[2.747403413,48.84348962],[2.887763814,48.796096072],[2.751002398,48.736791112],[2.639433875,48.800837444],[2.747403413,48.84348962]]]}",108167884.856
      CSV
